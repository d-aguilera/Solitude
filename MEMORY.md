...
- `plugins/core-pack-v1/`: independently built first-party browser plugin pack discovered at runtime by standalone and remote clients; currently contains axial-view, body-label, orbit-segment, solar-system-material, targeting-laser, trajectory, and velocity-segment plugins plus the material plugin's texture assets.
