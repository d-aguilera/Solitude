...
- `packages/sim/src/localization.ts`: Solitude locale resolution, unit formatting, message interpolation, and generic entity-name-provider helpers. Client/plugin JSON bundles live in their owning package directories.
