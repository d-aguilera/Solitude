...
- Add `&autopilot=v1`, `&autopilot=v2`, `&autopilot=v3`, `&autopilot=v4`,
  or `&autopilot=v5` to select the circle-now/autopilot algorithm for
  interactive or playback runs. The default is `v5`.
