...
import fragmentShaderSource from "../../../../rasterize/webgl/shaders/solidMesh.frag.glsl?raw";
import vertexShaderSource from "../../../../rasterize/webgl/shaders/solidMesh.vert.glsl?raw";
